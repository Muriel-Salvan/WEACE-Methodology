    ...
    module Adapters
      ...
      class DummyProduct
        ...
        class DummyProcessExecFail
          ...
          def check
            if ($Variables[:DummyProduct_DummyProcessExecFail_Calls] == nil)
              $Variables[:DummyProduct_DummyProcessExecFail_Calls] = []
            end
            $Variables[:DummyProduct_DummyProcessExecFail_Calls] << [ 'check', [] ]
          ...
          def execute
            ...
            $Variables[:DummyProduct_DummyProcessExecFail_Calls] << [ 'execute', [] ]
          ...
          def getDefaultConfig
            ...
            $Variables[:DummyProduct_DummyProcessExecFail_Calls] << [ 'getDefaultConfig', [] ]

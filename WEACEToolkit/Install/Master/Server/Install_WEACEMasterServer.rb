  ...
  module Master
    ...
    class Server
      ...
      def execute(iParameters)
        ...
        lShowAdaptersFileName = "#{lProviderConfig.CGIDir}/WEACE/ShowWEACEMasterInfo.cgi"
...
"
        ...
        logDebug "Generate file where WEACE Master Adapters register themselves (#{lAdaptersRegisterFile}) ..."

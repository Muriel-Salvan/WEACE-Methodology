    ...
    module Providers
      ...
      class SourceForge
        ...
        def getDescription(ioDescription)
          ...
          ioDescription.Description = 'The SourceForge.net environment specifics for WEACE Slave Client/Adapters.'
        ...
        def getRuntimeWEACESlaveClientEnvironment(ioProviderConfig)

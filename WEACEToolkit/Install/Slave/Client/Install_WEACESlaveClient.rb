  ...
  module Slave
    ...
    class Client
      ...
      def execute(iParameters)
        ...
        lShowComponentsFileName = "#{lProviderConfig.CGIDir}/WEACE/ShowInstalledSlaveComponents.cgi"
        log "Generate CGI script that shows installed WEACE Slave Adapters and Listeners (#{lShowComponentsFileName}) ..."
        require 'fileutils'
...
require 'Slave/Client/ShowInstalledSlaveComponents.rb'
# Print header
